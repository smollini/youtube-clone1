...
//
    public static final String BUCKET_NAME = "smollinibucket";
        //
    ...
    public String uploadFile(MultipartFile file) {
        ...
        try {
            ...
            throw  new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,"an exception occured whil uploading");
        }
